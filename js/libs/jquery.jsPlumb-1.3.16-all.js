					...
					if (endpoints) {
						...
						for (var i = 0; i < endpoints.length; i++)
						{
							if (endpoints[i] != endpoint) {
								...
								//console.log('found endpoint to be deleted:',endpoints[i].elementId);
							}
						}
...
between this method and jsPlumb.reset).  
		...
		*/
		this.repaintEverything = function() {				
			for ( var elId in endpointsByElement) {
				//console.log('repaintEverything elID:',elId,'_getElementObject(elId)',_getElementObject(elId));
